...
urlpatterns = [
    ...
    path('create/cuisine/', views.Cuisinecreate.as_view(),
         name='create-cuisine'),
    path('cuisine/update/<int:cuisine_id>/',
         views.CuisineUpdateView.as_view(), name='update-cuisine'),
    path('delete/cuisine/<int:cuisine_id>/',
         views.DeleteCuisineView.as_view(), name='delete-cuisine'),
